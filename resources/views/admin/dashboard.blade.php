...
<div class="bg-gradient-to-r from-emerald-500 to-teal-500 rounded-3xl p-8 mb-8 text-white shadow-lg">
    <div class="flex items-center justify-between">
        ...
        <div class="hidden md:flex w-24 h-24 bg-white/20 rounded-3xl items-center justify-center text-5xl">📊</div>
    </div>
</div>
...
<div class="grid md:grid-cols-5 gap-4 mb-8">
    ...
    <div class="bg-white rounded-3xl p-5 shadow-sm border-2 border-orange-100 ring-4 ring-orange-50">
...
<div class="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 mb-8">
    ...
    <div class="h-80"><canvas id="visitorChart"></canvas></div>
</div>
